...
abstract class Folder
  ...
  factory Folder.fromJson(Map<String, dynamic> jsonSerialization) {
    return Folder(
      ...
      notes: jsonSerialization['notes'] == null
          ? null
          : _irdrtnbo.Protocol().deserialize<List<_io8vvye9.Note>>(
  ...
  static FolderIncludeList includeList({
    _is.WhereExpressionBuilder<FolderTable>? where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<FolderTable>? orderBy,
    _is.OrderByListBuilder<FolderTable>? orderByList,
...
class FolderUpdateTable extends _is.UpdateTable<FolderTable> {
...
class FolderTable extends _is.Table<_is.UuidValue?> {
  ...
  _is.ManyRelation<_io8vvye9.NoteTable>? _notes;
  ...
  _is.ManyRelation<_io8vvye9.NoteTable> get notes {
    ...
    _notes = _is.ManyRelation<_io8vvye9.NoteTable>(
  ...
  @override
  List<_is.Column> get columns => [id, spaceId, name];
...
class FolderInclude extends _is.IncludeObject {
  ...
  @override
  _is.Table<_is.UuidValue?> get table => Folder.t;
}

class FolderIncludeList extends _is.IncludeList {
  FolderIncludeList._({
    _is.WhereExpressionBuilder<FolderTable>? where,
    super.limit,
    super.offset,
...
class FolderRepository {
  ...
  Future<List<Folder>> upsert(
    _is.DatabaseSession session,
    List<Folder> rows, {
    required _is.ColumnSelections<FolderTable> conflictColumns,
    _is.ColumnSelections<FolderTable>? updateColumns,
    _is.WhereExpressionBuilder<FolderTable>? updateWhere,
    _is.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<Folder>> update(
    _is.DatabaseSession session,
    List<Folder> rows, {
    _is.ColumnSelections<FolderTable>? columns,
    _is.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<Folder?> updateById(
    _is.DatabaseSession session,
    _is.UuidValue id, {
    required _is.ColumnValueListBuilder<FolderUpdateTable> columnValues,
    _is.Transaction? transaction,
  }) async {
  ...
  Future<List<Folder>> updateWhere(
    _is.DatabaseSession session, {
    required _is.ColumnValueListBuilder<FolderUpdateTable> columnValues,
    required _is.WhereExpressionBuilder<FolderTable> where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<FolderTable>? orderBy,
    _is.OrderByListBuilder<FolderTable>? orderByList,
