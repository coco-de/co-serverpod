...
class _Migration20260923070851093 implements MigrationVersionSql {
  @override
  String get version => '20260923070851093';
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('offline_sync_watch_test', '20260923070851093', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260923070851093', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
