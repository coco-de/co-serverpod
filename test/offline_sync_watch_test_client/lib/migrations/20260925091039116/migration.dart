...
class _Migration20260925091039116 implements MigrationVersionSql {
  @override
  String get version => '20260925091039116';
...
CREATE TABLE "attachment" (
    ...
    CONSTRAINT "attachment_fk_0" FOREIGN KEY ("spaceId") REFERENCES "offline_sync_spaces" ("id") ON DELETE CASCADE ON UPDATE NO ACTION,
    CONSTRAINT "attachment_fk_1" FOREIGN KEY ("noteId") REFERENCES "note" ("id") ON DELETE CASCADE ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED
) STRICT;
...
INSERT INTO "serverpod_sqlite_schema" VALUES
    ...
    ('attachment', 'noteId', 'uuid', NULL),
    ('folder', 'id', 'uuid', NULL),
    ('note', 'id', 'uuid', NULL),
    ('note', 'archived', 'boolean', NULL),
    ('note', 'folderId', 'uuid', NULL),
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('offline_sync_watch_test', '20260925091039116', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260925091039116', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
...
CREATE TABLE "folder" (
    ...
    "spaceId" INTEGER,
    "name" TEXT NOT NULL,
    CONSTRAINT "folder_fk_0" FOREIGN KEY ("spaceId") REFERENCES "offline_sync_spaces" ("id") ON DELETE CASCADE ON UPDATE NO ACTION
) STRICT;


--
-- Class LocalDraft as table local_draft
--
...
CREATE TABLE "note" (
    ...
    "folderId" BLOB,
    CONSTRAINT "note_fk_0" FOREIGN KEY ("spaceId") REFERENCES "offline_sync_spaces" ("id") ON DELETE CASCADE ON UPDATE NO ACTION,
    CONSTRAINT "note_fk_1" FOREIGN KEY ("folderId") REFERENCES "folder" ("id") ON DELETE SET NULL ON UPDATE NO ACTION
) STRICT;
