...
abstract class Note
  ...
  factory Note.fromJson(Map<String, dynamic> jsonSerialization) {
    return Note(
      ...
      archived: jsonSerialization['archived'] == null
          ? null
          : _isc.BoolJsonExtension.fromJson(jsonSerialization['archived']),
      folderId: jsonSerialization['folderId'] == null
          ? null
          : _isc.UuidValueJsonExtension.fromJson(jsonSerialization['folderId']),
      folder: jsonSerialization['folder'] == null
          ? null
          : _ighle6sp.Protocol().deserialize<_ij200e11.Folder>(
  ...
  static NoteIncludeList includeList({
    _isd.WhereExpressionBuilder<NoteTable>? where,
    int? limit,
    int? offset,
    _isd.OrderByBuilder<NoteTable>? orderBy,
    _isd.OrderByListBuilder<NoteTable>? orderByList,
    NoteInclude? include,
  }) {
...
class _NoteImpl extends Note {
  ...
  Note copyWith({
    ...
    return Note(
      ...
      folderId: folderId is _isc.UuidValue? ? folderId : this.folderId,
      folder: folder is _ij200e11.Folder? ? folder : this.folder?.copyWith(),
    );
  }
}

class NoteUpdateTable extends _isd.UpdateTable<NoteTable> {
  ...
  _isd.ColumnValue<bool, bool> archived(bool value) =>
      _isd.ColumnValue(table.archived, value);

  _isd.ColumnValue<_isc.UuidValue, _isc.UuidValue> folderId(
    _isc.UuidValue? value,
  ) => _isd.ColumnValue(table.folderId, value);
}

class NoteTable extends _isd.Table<_isc.UuidValue?> {
  NoteTable({super.tableRelation}) : super(tableName: 'note') {
    ...
    archived = _isd.ColumnBool('archived', this, hasDefault: true);
    folderId = _isd.ColumnUuid('folderId', this);
  }
  ...
  late final _isd.ColumnBool archived;

  late final _isd.ColumnUuid folderId;

  _ij200e11.FolderTable? _folder;

  _ij200e11.FolderTable get folder {
    if (_folder != null) return _folder!;
    _folder = _isd.createRelationTable(
  ...
  @override
  List<_isd.Column> get columns => [id, spaceId, title, archived, folderId];
...
class NoteInclude extends _isd.IncludeObject {
  ...
  @override
  Map<String, _isd.Include?> get includes => {'folder': _folder};

  @override
  _isd.Table<_isc.UuidValue?> get table => Note.t;
}

class NoteIncludeList extends _isd.IncludeList {
  NoteIncludeList._({
    _isd.WhereExpressionBuilder<NoteTable>? where,
    super.limit,
    super.offset,
...
class NoteRepository {
  ...
  Future<List<Note>> upsert(
    _isd.DatabaseSession session,
    List<Note> rows, {
    required _isd.ColumnSelections<NoteTable> conflictColumns,
    _isd.ColumnSelections<NoteTable>? updateColumns,
    _isd.WhereExpressionBuilder<NoteTable>? updateWhere,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<Note>> update(
    _isd.DatabaseSession session,
    List<Note> rows, {
    _isd.ColumnSelections<NoteTable>? columns,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<Note?> updateById(
    _isd.DatabaseSession session,
    _isc.UuidValue id, {
    required _isd.ColumnValueListBuilder<NoteUpdateTable> columnValues,
    _isd.Transaction? transaction,
  }) async {
  ...
  Future<List<Note>> updateWhere(
    _isd.DatabaseSession session, {
    required _isd.ColumnValueListBuilder<NoteUpdateTable> columnValues,
    required _isd.WhereExpressionBuilder<NoteTable> where,
    int? limit,
    int? offset,
    _isd.OrderByBuilder<NoteTable>? orderBy,
    _isd.OrderByListBuilder<NoteTable>? orderByList,
