...
abstract class Attachment
  ...
  static AttachmentIncludeList includeList({
    _isd.WhereExpressionBuilder<AttachmentTable>? where,
    int? limit,
    int? offset,
    _isd.OrderByBuilder<AttachmentTable>? orderBy,
    _isd.OrderByListBuilder<AttachmentTable>? orderByList,
...
class AttachmentUpdateTable extends _isd.UpdateTable<AttachmentTable> {
  ...
  ) => _isd.ColumnValue(table.noteId, value);
}

class AttachmentTable extends _isd.Table<_isc.UuidValue?> {
  ...
  @override
  List<_isd.Column> get columns => [id, spaceId, name, noteId];
}

class AttachmentInclude extends _isd.IncludeObject {
  AttachmentInclude._();
  ...
  @override
  _isd.Table<_isc.UuidValue?> get table => Attachment.t;
}

class AttachmentIncludeList extends _isd.IncludeList {
...
class AttachmentRepository {
  ...
  Future<List<Attachment>> upsert(
    _isd.DatabaseSession session,
    List<Attachment> rows, {
    required _isd.ColumnSelections<AttachmentTable> conflictColumns,
    _isd.ColumnSelections<AttachmentTable>? updateColumns,
    _isd.WhereExpressionBuilder<AttachmentTable>? updateWhere,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<Attachment>> update(
    _isd.DatabaseSession session,
    List<Attachment> rows, {
    _isd.ColumnSelections<AttachmentTable>? columns,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<Attachment?> updateById(
    _isd.DatabaseSession session,
    _isc.UuidValue id, {
    required _isd.ColumnValueListBuilder<AttachmentUpdateTable> columnValues,
    _isd.Transaction? transaction,
  }) async {
  ...
  Future<List<Attachment>> updateWhere(
    _isd.DatabaseSession session, {
    required _isd.ColumnValueListBuilder<AttachmentUpdateTable> columnValues,
    required _isd.WhereExpressionBuilder<AttachmentTable> where,
    int? limit,
    int? offset,
    _isd.OrderByBuilder<AttachmentTable>? orderBy,
    _isd.OrderByListBuilder<AttachmentTable>? orderByList,
