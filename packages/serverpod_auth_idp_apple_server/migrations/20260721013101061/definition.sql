...
--
-- Class AppleKrAccount as table serverpod_auth_idp_apple_kr_account
--
CREATE TABLE "serverpod_auth_idp_apple_kr_account" (
...
-- Indexes
CREATE UNIQUE INDEX "serverpod_auth_idp_apple_kr_identifier" ON "serverpod_auth_idp_apple_kr_account" USING btree ("userIdentifier");
...
--
-- Foreign relations for "serverpod_auth_idp_apple_kr_account" table
--
ALTER TABLE ONLY "serverpod_auth_idp_apple_kr_account"
    ADD CONSTRAINT "serverpod_auth_idp_apple_kr_account_fk_0"
...
--
-- MIGRATION VERSION FOR serverpod_auth_idp_apple
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_idp_apple', '20260721013101061', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260721013101061', "timestamp" = now();
